...
function setup() {
  ...
  engine = Engine.create();
    ...
    tom=new Tom(100,800)
    jerry=new Jerry(1600,820)
   object1=new Throw1(450,100)
   object2=new Throw1(1600,100)
    sling1=new SlingShot (object1.body,{x:450,y:700})
    sling2=new SlingShot (object2.body,{x:1520,y:710})
